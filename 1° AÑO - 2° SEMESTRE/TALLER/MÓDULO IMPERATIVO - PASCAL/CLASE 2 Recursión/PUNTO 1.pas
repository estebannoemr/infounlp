...
a. Implementar un módulo recursivo que permita leer una secuencia de caracteres terminada en
* punto y los almacene en un vector con dimensión física igual a 10.
...
* en punto y retorne la cantidad de caracteres leidos. 
...
* en punto y retorne una lista con los caracteres leidos.
f. Implemente un módulo recursivo que reciba la lista generada en d. e imprima los valores
* de la lista en el mismo orden que están almacenados.
g. Implemente un módulo recursivo que reciba la lista generada en d. e imprima los valores
* de la lista en orden inverso al que están almacenados.
}
